...
gulp.task("jscs", function () {
  return gulp.src("src/js/**/*.js").pipe(jscs()).pipe(jscs.reporter());
});
...
gulp.task(
  ...
  gulp.parallel(
    ...
    function () {
      return gulp.src(["tools/**/*"]).pipe(
        sftp({
          host: "tour-360.ru",
          auth: "admin",
          remotePath:
            "/var/www/tour-360.ru/tour-player/" + pjson.version + "/tools",
        })
      );
    }
  )
