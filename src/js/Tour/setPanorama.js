...
Tour.setPanorama = function (id, zoomin, callback) {
  Tour.backgroundImage.transitionStart(
    function () {
      Tour.mesh.rotation.set(
        0,
        Math.PI / 2 - ((this.getPanorama(id).heading || 0) / 180) * Math.PI,
        0
      );
      ...
      this.view.rotation.auto =
        panorama.autorotation !== false &&
