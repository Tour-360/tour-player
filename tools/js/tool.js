...
var state = {
	...
	get: function(){
		...
		if(!this.current.floors){
			this.current.floors = [
				{height: 400, title:'Lower lavel (garage)', plan:{imageURL: '../floors/0.svg', x:0, y:0, width:6830.492121379737}},
				{height: 400, title:'First floor', plan:{imageURL: '../floors/1.svg', x:0, y:0, width:6830.492121379737}},
				{height: 400, title:'second floor', plan:{imageURL: '../floors/2.svg', x:0, y:0, width:6830.492121379737}},
				{height: 400, title:'Third floor', plan:{imageURL: '../floors/3.svg', x:0, y:0, width:6830.492121379737}},
				{height: 400, title:'Fourth floor', plan:{imageURL: '../floors/4.svg', x:0, y:0, width:6830.492121379737}},
				{height: 400, title:'Fifth floor', plan:{imageURL: '../floors/5.svg', x:0, y:0, width:6830.492121379737}},
				{height: 400, title:'Roof lavel', plan:{imageURL: '../floors/6.svg', x:0, y:0, width:6830.492121379737}},
			]
		}
		this.set()
		return this.current;
